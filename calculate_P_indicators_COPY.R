...
outdir <- paste("F:\\impact_index\\ERA5\\processed\\",sep="")
resolution <- 0.05

#precipitation input
Pannual <- brick(paste("F:\\impact_index\\ERA5\\yearly\\era5_total-precipitation_yearsum_2001-2017.tif",sep=""))
Pymonmean <- brick(paste("F:\\impact_index\\ERA5\\monthly\\era5_total-precipitation_ymonmean_2001-2017_global.tif",sep=""))
